...
const Footer = () => {
  return (
    <footer id="contact" className="bg-slate-900 text-white pt-12 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
              Find your dream home with Prestige. We provide the most accurate
              and up-to-date property listings to help you make the best choice.
            </p>
          </div>
